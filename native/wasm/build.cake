...
// renames' below) -- but unlike freetype2/libjpeg-turbo/libpng, that API is also what the
...
// style wrapper the way SkiaSharp has for freetype2/libjpeg-turbo/libpng). Its internal
